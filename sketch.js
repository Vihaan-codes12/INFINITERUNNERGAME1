...
function setup() {
  ...
  mario = createSprite(50, displayHeight-70, 20, 50);
  mario.addAnimation("running", mario_running);
  mario.scale = 0.5;

  

  ground = createSprite(0, displayHeight-50, 800, 10);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(600, displayHeight+500, 40, 10);
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    var obstacle = createSprite(600, displayHeight-75, 10, 40);
